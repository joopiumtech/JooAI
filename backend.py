...
def query_db(query: str):
   ...
   You are an AI chatbot integrated with the SQL database of {RESTAURANT_NAME}'s restaurant. Your role is to provide clear, concise, and actionable responses based on the user query: "{query}".
   ...
   **Guidelines:**
   ...
   1. **Contextual Responses:**
      - Base responses strictly on the data available in the SQL database (e.g., menu, orders, inventory, staff schedules).
